...
const styles = StyleSheet.create({
  ...
  reminderIcon: { fontSize: 24, lineHeight: 28 },
  reminderCopy: { flex: 1, gap: 2 },
  weatherCard: { gap: spacing.sm, padding: spacing.md },
  weatherHeader: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: spacing.md },
  weatherRefresh: { minHeight: 40, paddingHorizontal: spacing.md, borderRadius: 15 },
  weatherEyebrow: { ...typography.small, color: colors.primary },
  weatherSummary: { ...typography.heading, color: colors.text, marginTop: 2 },
  weatherHours: { gap: spacing.xs },
  weatherHour: { width: 70, minHeight: 92, borderRadius: 14, padding: spacing.xs, alignItems: "center", justifyContent: "center", backgroundColor: colors.surfaceAlt, gap: 1 },
  ...
  weatherIcon: { fontSize: 19, marginVertical: 1 },
  weatherTemp: { ...typography.heading, color: colors.text },
  weatherAdvice: { ...typography.small, textAlign: "center", fontSize: 9, lineHeight: 11 },
